...
<head>
    ...
    <title>Sudadera Pulse Runners Club & Trainig Club</title>
...
<body oncontextmenu="return false" onkeydown="return false">
    ...
    <div class="detalle-prenda">
        <div class="imagenes-prenda">
            <img src="imgs/Training Club(Bien)3.png" alt="Sudadera - Vista Frontal">
            <img src="imgs/Untitled Project (6).png" alt="Sudadera - Vista Trasera">
        </div>
    <!-- Contenedor de informacion -->
        <div class="descripcion-prenda">
            <h2>Sudadera Training Club Negra</h2>
            <p>Precio: <strong>₡00.000</strong></p>
            <p>Descripción: Sudadera deportiva negra con logos Training Club & Pulse Runners Club en color rosa por la parte frontal.</p>
            <p>Materiales: 100% Algodon de alta calidadad.</p>
