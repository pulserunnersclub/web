...
document.getElementById("order-form").addEventListener("submit", (e) => {
  ...
  emailjs
    ...
    .then(() => {
      alert("Orden enviada con exito, pronto seras contactado.")
      carrito.length = 0; // Vaciar el carrito después de enviar
      actualizarCarrito();
    })
    .catch((error) => {
    alert("Error, hubo un probelma con tu orden, porfavor contactar a soporte.")
    });
});